...
const FEATURES = [
    ...
    { title: 'TypeScript', desc: 'JSX type checking via Vite. Full Python-to-React type bridge on the roadmap.', icon: 'M6.75 7.5l3 2.25-3 2.25m4.5 0h3m-9 8.25h13.5A2.25 2.25 0 0021 18V6a2.25 2.25 0 00-2.25-2.25H5.25A2.25 2.25 0 003 6v12a2.25 2.25 0 002.25 2.25z' },
    ...
    { title: 'Client Navigation', desc: '<Link> for instant SPA-style routing. Hover prefetch built in.', icon: 'M13.19 8.688a4.5 4.5 0 011.242 7.244l-4.5 4.5a4.5 4.5 0 01-6.364-6.364l1.757-1.757m13.35-.622l1.757-1.757a4.5 4.5 0 00-6.364-6.364l-4.5 4.5a4.5 4.5 0 001.242 7.244' },
...
const ECOSYSTEM = [
    ...
    {
        title: 'Pyxle Langkit',
        desc: 'VS Code extension with .pyx syntax highlighting, completions, hover, go-to-definition, diagnostics, and formatting.',
        icon: 'M6.75 7.5l3 2.25-3 2.25m4.5 0h3m-9 8.25h13.5A2.25 2.25 0 0021 18V6a2.25 2.25 0 00-2.25-2.25H5.25A2.25 2.25 0 003 6v12a2.25 2.25 0 002.25 2.25z',
        status: 'beta',
        href: 'https://marketplace.visualstudio.com/items?itemName=pyxle.pyxle-language-tools',
    },
    {
        title: 'Debug Tools',
            ...
            <div className="relative z-10 mx-auto max-w-4xl">
                <Reveal>
                    <SectionLabel
                        ...
                        subtitle="The core framework is stable and battle-tested. These tools are in active development to grow the ecosystem."
                    />
                </Reveal>
